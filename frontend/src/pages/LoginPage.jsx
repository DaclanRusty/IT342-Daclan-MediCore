        ...
        <div style={{
          ...
          <div style={{flex:'1 1 300px',maxWidth:400}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:10,marginBottom:24}}>
              {[
                {icon:'🔒',text:'Secure & encrypted connection',bg:'#eff6ff',border:'#bfdbfe',tc:'#1d4ed8'},
                {icon:'⚡',text:'Real-time appointment updates',bg:'#f0fdf4',border:'#bbf7d0',tc:'#065f46'},
                {icon:'📱',text:'Multi-device accessibility',bg:'#f5f3ff',border:'#ddd6fe',tc:'#5b21b6'},
              ].map((f,i)=>(
          ...
          <div className="mc-card" style={{flex:'1 1 300px',maxWidth:400}}>
            ...
            {/* Trust row */}
            <div style={{display:'flex',justifyContent:'center',alignItems:'center',gap:16,marginTop:14,flexWrap:'wrap'}}>
              {[{icon:'🔒',t:'SSL Secured'},{icon:'🛡️',t:'Privacy Protected'},{icon:'✅',t:'Google Verified'}].map((t,i)=>(
                <div key={i} style={{display:'flex',alignItems:'center',gap:4,fontSize:11,color:'#64748b',fontWeight:500}}>
                  <span style={{fontSize:12}}>{t.icon}</span>{t.t}
                </div>
              ))}
            </div>
          </div>
